...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Any of the mandatory fields not specified")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. JobFestGo informs user that mandatory fields not specified")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. Phone number already exists.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. JobFestGo informs user that phone number already exists.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. Email is in incorrect format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. JobFestGo informs user that email is in wrong format.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1d. Phone number is in incorrect format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1d1. JobFestGo informs user that phone number is in wrong format.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1e. Tag is not found in list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1e1. JobFestGo informs user that tag input is not in tag List.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The given tag name is already in the tag list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. JobFestGo shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. Missing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t/")]),_v(" in the command.")])]),_v(" "),_c('li',[_c('ul',[_c('li',[_c('p',[_v("3b1. JobFestGo shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. Missing tag name.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. JobFestGo shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sat, 14 Oct 2023, 10:15:34 GMT+8]")])])])}
}];
